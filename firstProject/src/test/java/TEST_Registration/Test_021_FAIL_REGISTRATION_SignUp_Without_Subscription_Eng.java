...
public class Test_021_FAIL_REGISTRATION_SignUp_Without_Subscription_Eng extends BaseClass {

    @Test(groups = "High")
    public void Test_021_FAIL_REGISTRATION_SignUp_Without_Subscription_Eng() {
        ...
        registrationPage.phoneField().inputText("38");
