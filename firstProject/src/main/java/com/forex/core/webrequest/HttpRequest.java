package com.invest.core.web.webrequest;


import com.invest.core.web.websocket.HttpClientExample;
...
public class HttpRequest {
    ...
    private void sendPost(String url, String postParams) throws Exception {
        ...
        conn.setRequestProperty("Referer", "https:/login.html");
    ...
    private String GetPageContent(String url) throws Exception {
        ...
        if (cookies != null) {
            for (String cookie : this.cookies) {
                System.out.println("kook" + cookie);
                conn.addRequestProperty("Cookie", cookie.split(";", 1)[0]);
                System.out.println("COOOKe" + cookie);
            }
        }
        int responseCode = conn.getResponseCode();
